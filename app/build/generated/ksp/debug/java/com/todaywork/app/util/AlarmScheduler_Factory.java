...
public final class AlarmScheduler_Factory implements Factory<AlarmScheduler> {
  ...
  public static AlarmScheduler_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new AlarmScheduler_Factory(Providers.asDaggerProvider(contextProvider));
  }
